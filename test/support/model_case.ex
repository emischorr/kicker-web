defmodule KickerWeb.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import KickerWeb.ModelCase
    end
  end

  setup tags do
    :ok = Ecto.Adapters.SQL.Sandbox.checkout(KickerWeb.Repo)

    unless tags[:async] do
      Ecto.Adapters.SQL.Sandbox.mode(KickerWeb.Repo, {:shared, self()})
    end
  ...
  def errors_on(struct, data) do
     ...
     |> Ecto.Changeset.traverse_errors(&KickerWeb.ErrorHelpers.translate_error/1)
